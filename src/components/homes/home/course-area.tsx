...
import {coursesSelectors} from '@/src/bll/courses';
import {PATH} from '@/public/assets/constants/routes';

const CourseArea = () => {
    const courses = useAppSelector(coursesSelectors.selectCourses);
    return (
        <>
            <section
                className="course-area pt-115 pb-110 wow fadeInUp theme-bg-2"
                            ...
                            <div key={item.id} className="col-xl-4 col-lg-6 col-md-6">
                                <div className="tpcourse mb-40">
                                    <div className="tpcourse__thumb p-relative w-img fix">
                                        <Link href={`${PATH.COURSES_DETAILS}/${item.id}`}>
                                    ...
                                    <div className="tpcourse__content">
                                        <div className="tpcourse__avatar d-flex align-items-center mb-20">
                                            ...
                                            <h4 className="tpcourse__title">
                                                <Link href={`${PATH.COURSES_DETAILS}/${item.id}`}>{item.title}</Link>
                                            </h4>
                                        </div>
                    ...
                    <div className="row text-center">
                        <div className="col-lg-12">
                            <div className="course-btn mt-20">
                                <Link className="tp-btn" href="/course-details/course-details">
                                    Browse All Courses
                                </Link>
                            </div>
                        </div>
